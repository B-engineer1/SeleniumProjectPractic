...
public class asdfg {
	...
	public static void main(String[] args) throws InterruptedException {
	     ...
	     WebElement checkBox = driver.findElement(By.xpath("//input[@data-testing-id='confirmationChecked']"));
	     
	  //   driver.findElement(By.xpath("//input[@data-testing-id='confirmationChecked']")).click();
